  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (response.data === "already exists") {
        alert("Username or hotel name already exists.");
        setUsername("");
        setHotelname("");
      } else {
        Cookies.set("accessToken", response.data.accessToken);
        Cookies.set("hotelname", hotelname);
        navigate('/home'); // Or navigate to an admin dashboard
  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 py-12">
      ...
      <div className="w-full max-w-md p-8 space-y-6 bg-white rounded-lg shadow-md">
        <h2 className="text-2xl font-bold text-center text-gray-900">Create Admin Account</h2>
